...
echo "strings data/test.dat | grep polkitd" >> $filename
strings data/test.dat | grep polkitd | tee -a $filename
...
echo "strings packets.pcap | grep polkitd" >> $filename
strings packets.pcap | grep polkitd | tee -a $filename
yes|rm packets.pcap
